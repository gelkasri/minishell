...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_fct_longlong.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gel-kasr <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/17 04:49:28 by gel-kasr          #+#    #+#             */
/*   Updated: 2019/12/09 19:53:52 by gel-kasr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/ft_printf.h"

static void	sub_print_ll(long long i, t_fmt fmt, int nb_space, int nb_zero)
{
	int len;
...
int			print_longlong(va_list *ap, t_fmt fmt)
{
	...
	sub_print_ll(i, fmt, nb_space, nb_zero);
